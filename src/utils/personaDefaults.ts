...
export const INDUSTRY_DEFAULTS: Record<ReceiptTheme, IndustryDefault> = {
  ...
  retail: {
    companyName: 'Urban Mart Retail',
    address: '78 Shopping Blvd, Downtown',
    phone: '+1 555-0500',
    email: 'hello@urbanmart.com',
    website: 'www.urbanmart.com',
    notes: 'Thank you for shopping with us! All sales are final.',
    footerText: 'This is an official sales receipt generated by Urban Mart.'
  }
};
